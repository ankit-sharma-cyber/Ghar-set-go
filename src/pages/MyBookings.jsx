...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title Title="My Bookings" subTitle=' Easily manage your past, current, and upcoming hotel reservation in one place. Plan your trips seamlessly with just a few clicks'
      align="left"/>
      ...
      {bookings.map((booking)=>(
        <div key={booking._id} className='grid gird-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
            {/* hotel details */}
